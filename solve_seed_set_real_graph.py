...
threshold = 8
#filepath = '/home/mrankawat/Documents/matrix_dataset_public/soc-karate.mtx'
#filepath = '/home/mrankawat/Documents/matrix_dataset_public/ca-AstroPh.mtx'
filepath = '/home/mrankawat/Documents/matrix_dataset_public/CollegeMsg.txt'
...
final_seed_set_cvx = []
for pos in seed_set_cvx1:
    final_seed_set_cvx.append(nodes[pos])
ss_check = []
print ("seed set cvx1", final_seed_set_cvx)
for node in final_seed_set_cvx:
